...
public class WxOrderService {
     ...
     * @return
     */
    public Object updatePayStatus(Integer userId, String body) {
        ...
        Integer orderStatus = JacksonUtil.parseInteger(body, "orderStatus");
        if(orderStatus == null){
            return ResponseUtil.badArgument();
        }
        //原来是订单的状态信息
        ...
        //判断当前的订单的状态
        if (!handleOption.isPay()) {
            return ResponseUtil.fail(ORDER_INVALID_OPERATION, "订单不能确认支付");
        }
