...
public class WxAuthController {
    ...
    @Autowired
    private LitemallUserAttributeService userAttributeService;
    ...
    public Object login(@RequestBody String body, HttpServletRequest request) {
        System.out.println("body :"+body+"---> request :"+request);
        ...
        Map<String, String> attributes = userAttributeService.getUserAttributes(user.getId());
        userInfo.setCookie(Integer.parseInt(attributes.get("cookie")));
        System.out.println("-->"+Integer.parseInt(attributes.get("cookie")));
    ...
    /**
     *
     * @param info {"username":xxx,"password":xxx,...}
     * @param request
     * @return
     */
    @PostMapping("pcRegister")
    public Object pcRegister(@RequestBody Map<String, String> info, HttpServletRequest request){
        return userInfoService.addFromPc(info,request);
    }
